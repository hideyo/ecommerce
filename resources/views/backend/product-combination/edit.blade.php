...
<div class="row rowTopPadding">
	...
	<div class="col-sm-9 col-md-10 main">
		...
		<ol class="breadcrumb">
			...
			<li><a href="{!! URL::route('product-combination.index', $product->id) !!}">combinations</a></li>
				...
				<div class="panel panel-primary tab-content">
					...
					<div class="panel-body">    
						...
						<div class="col-md-12">
							...
							{!! Form::model($productCombination, array('method' => 'put', 'route' => array('product-combination.update', $product->id, $productCombination->id), 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator')) !!}
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<select multiple="multiple" class="selected_attribute_ids form-control" name="selected_attribute_ids[]">
										@foreach($attributes as $key => $val) 
										<option value="{!! $key !!}" id="{!! $val['group_id'] !!}" selected="selected">{!! $val['value'] !!}</option>
										@endforeach
									</select>
								</div>
								<div class="col-sm-2">
