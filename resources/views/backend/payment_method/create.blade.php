...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="{{ URL::route('payment-method.create') }}">Create</a></li>
        </ul>
    </div>
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <h2>Payment method <small>create</small></h2>
        <hr/>
        @include('flash::message')

        {!! Form::open(array('route' => array('payment-method.store'), 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator')) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    {!! Form::select('percent_of_total', array('0' => 'No', '1' => 'Yes'), '0', array('class' => 'form-control')) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    {!! Form::select('payment_external', array('0' => 'No', '1' => 'Yes'), '0', array('class' => 'form-control')) !!}
                </div>
            </div>

            <div class="form-group">
                {!! Form::label('mollie_external_payment_way', 'Mollie', array('class' => 'col-sm-3 control-label')) !!}
                <div class="col-sm-5">
