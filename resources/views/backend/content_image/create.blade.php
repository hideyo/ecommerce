...
<div class="row rowTopPadding">
    ...
    <div class="col-sm-9 col-md-10 main">
        <ol class="breadcrumb">
          ...
          <li><a href="{!! URL::route('content.index') !!}">Product categories</a></li>
        ...
        <div class="row rowTopPadding">
            <div class="col-md-12">
                <div class="panel-body">
    			    ...
    			    {!! Form::open(array('route' => array('content.images.store', $content->id), 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator')) !!}
