...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
            <li><a href="{{ URL::route('order-status.index') }}">Overview <span class="sr-only">(current)</span></a></li>
            <li class="active"><a href="{{ URL::route('order-status.create') }}">Edit</a></li>
        </ul>
    </div>
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <ol class="breadcrumb">
            <li><a href="{{ URL::route('dashboard.index') }}">Dashboard</a></li>
            <li><a href="{{ URL::route('order-status.index') }}">Order statuses</a></li>  
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                {!! Form::select('order_is_validated', array('0' => 'No', '1' => 'Yes'), null, array('class' => 'form-control')) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                {!! Form::select('order_is_paid', array('0' => 'No', '1' => 'Yes'), null, array('class' => 'form-control')) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                {!! Form::select('count_as_revenue', array('0' => 'No', '1' => 'Yes'), null, array('class' => 'form-control')) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                {!! Form::select('order_is_delivered', array('0' => 'No', '1' => 'Yes'), null, array('class' => 'form-control')) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                {!! Form::select('order_is_cancelled', array('0' => 'No', '1' => 'Yes'), null, array('class' => 'form-control')) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                {!! Form::select('send_email_to_customer', array('0' => 'No', '1' => 'Yes'), null, array('class' => 'form-control')) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                {!! Form::select('attach_invoice_to_email', array('0' => 'No', '1' => 'Yes'), null, array('class' => 'form-control')) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                {!! Form::select('attach_order_to_email', array('0' => 'No', '1' => 'Yes'), null, array('class' => 'form-control')) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                 {!! Form::select('create_shipping_label', array('0' => 'No', '1' => 'Yes'), null, array('class' => 'form-control')) !!}
            </div>
        </div>
<!-- 
        <div class="form-group">
            ...
            <div class="col-sm-5">
                {!! Form::select('confirm_shipment_label', array('0' => 'No', '1' => 'Yes'), null, array('class' => 'form-control')) !!}
            </div>
        </div>
 -->
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-5">
                ...
                <a href="{!! URL::route('order-status.index') !!}" class="btn btn-large">Cancel</a>
            </div>
        </div>
        {!! Form::close() !!}
    </div>
