...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="{{ URL::route('general-setting.create') }}">Create</a></li>
        </ul>
    </div>
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <h2>General setting <small>create</small></h2>
        <hr/>
        {!! Notification::showAll() !!}

    {!! Form::open(array('route' => array('general-setting.store'), 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator')) !!}
